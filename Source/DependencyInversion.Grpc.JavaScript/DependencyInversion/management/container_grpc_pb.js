...
var DependencyInversion_management_container_pb = require('../../DependencyInversion/management/container_pb.js');

function serialize_dolittle_dependencyinversion_Bindings(arg) {
  if (!(arg instanceof DependencyInversion_management_container_pb.Bindings)) {
...
function deserialize_dolittle_dependencyinversion_Bindings(buffer_arg) {
  return DependencyInversion_management_container_pb.Bindings.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_dolittle_dependencyinversion_GetBindingsRequest(arg) {
  if (!(arg instanceof DependencyInversion_management_container_pb.GetBindingsRequest)) {
...
function deserialize_dolittle_dependencyinversion_GetBindingsRequest(buffer_arg) {
  return DependencyInversion_management_container_pb.GetBindingsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ContainerService = exports.ContainerService = {
  getBindings: {
    ...
    requestType: DependencyInversion_management_container_pb.GetBindingsRequest,
    responseType: DependencyInversion_management_container_pb.Bindings,
